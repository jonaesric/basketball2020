...
public class SettingsMenuNewGameController {
    /**
    ...
    public TextField getHeittokellonSummeriTxt() {
        return heittokellonSummeriTxt;
    }
     ...
     */
    @FXML
    private void changeScreenScoreboardMenuButtonPushed(ActionEvent event) throws IOException {
     ...
     */
    @FXML
    private void changeScreenNewGameButtonPushed(ActionEvent event) throws IOException {
        // Save settings
        saveSettings(event);
